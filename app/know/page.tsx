  ...
  return (
    <>
      ...
      <DataTable
        ...
        rows={[
          ["Sep 17–18, 2026", "Launch Scale Test — anyone who signs up on Steam", "Nothing. Progress is wiped after the test"],
          ["Sep 30–Oct 4, 2026", "Advance Access — Founder's Pack owners", "Live characters. Markets, Exchanges, and PvP matching stay separate for a period"],
          ["Oct 5, 2026", "Global free-to-play launch — everyone on PC", "This is the real start for players who skip the pack"],
        ]}
      />
      ...
      <DataTable
        ...
        rows={[
          ["Confirmed clients", "Windows PC through Steam and NC PURPLE"],
          ["Named hub regions", "US West, US East, Central Europe, South America, Japan"],
          ["Not confirmed", "Mobile, console, exact data-center cities, formal region-lock policy"],
      ...
      <DataTable
        ...
        rows={[
          ["Standard", "$24.99", "5-day Advance Access, cosmetics/title/consumables, 30 days of Membership"],
      ...
      />
      <Callout>
        You can level and clear content without paying. Full player-economy access sits behind Membership.
      </Callout>
      ...
      <DataTable
        ...
        rows={[
          ...
          [
            "Founder's Packs",
            "No global-style Advance Access. Similar cosmetics later sold in the KR shop",
