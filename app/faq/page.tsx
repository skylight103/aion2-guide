...
const faqs = [
  ...
  ["When does it come out?", "Monday October 5, 2026 on PC (Steam + PURPLE, Windows). Early Access / Advanced Access is September 30–October 4. Launch Scale Test September 17–18 is done and wiped."],
  ["What time do servers open?", "Not published as of September 19, 2026."],
  ["Do I need a Founder's Pack?", "No. Gameplay is free on October 5. Founders use Early Access / Advanced Access to finish the barracks."],
  ...
  ["Is there mobile or console?", "Not for this launch. Global is a PC Windows client."],
...
export default function FaqPage() {
  return (
    <>
      <PageHeader kicker="Reference" title="Common questions" lede="Short answers first. Confirmed global, then Korea as a warning." />
