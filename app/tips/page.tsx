...
export default function TipsPage() {
  return (
    <>
      ...
      />
      <Callout tone="red">Founder packs currently include 30 days of Membership. LST is done and wiped. KR/TW accounts cannot play here.</Callout>
        ...
        <div>
          ...
          <DataTable
            ...
            rows={[
              ...
              ["14", "LST is done and wiped. Steam: uninstall the playtest before Early Access / Advanced Access"],
            ]}
          />
        </div>
        <div>
